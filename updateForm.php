...
<form action="update.php" method="post">
    ...
    <p>
        ...
        <input type="text" name="sub_start_date" id="subStartDate" value="<?php echo $user['sub_start_date'] ?>">
    </p>
    <p>
        <label for="subEndDate">Subscription End Date: </label>
        <input type="text" name="sub_end_date" id="subEndDate" value="<?php echo $user['sub_end_date'] ?>">
    </p>
